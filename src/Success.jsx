...
const EVENTS_DATE = {
  "15-feb-2026": "Domingo 15 de Febrero",
  "20-feb-2026": "Viernes 20 de Febrero",
  "26-jun-2026": "Viernes 26 de Junio, 2026"
};

const CATEGORY_NAMES = {
  "MesaVipGold":          "VIP Table",
  "MesaVipSilver":        "Mesa Silver",
  "Suite 10 Personas":    "Suite 10 Personas",
  "Suite 20 Personas":    "Suite 20 Personas",
  "Verde Suite Gold":     "Suite 10 Personas",
  "Amarillo Suite Premium": "Suite 20 Personas"
};
...
function Success() {
  ...
  useEffect(() => {
    ...
    if (type && eventId && number) {
      setDetails({
        type:      type === 'mesa' ? 'VIP Table' : 'Suite Exclusiva',
